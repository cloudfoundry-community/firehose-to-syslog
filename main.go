...
var (
	...
	logFormatterType = kingpin.Flag("log-formatter-type", "Log formatter type to use. Valid options are JSONFormatter, TextFormatter. If none provided, defaults to JSONFormatter.").Envar("LOG_FORMATTER_TYPE").String()
)
